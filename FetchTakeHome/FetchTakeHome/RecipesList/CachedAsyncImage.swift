...
private class ImageLoader: ObservableObject {
    ...
    /// so we use a custom URLCache that will not only work better, but will also be used only for caching images
    /// and will give us extra control over how much ram and disk memory we want our app to occupy.
